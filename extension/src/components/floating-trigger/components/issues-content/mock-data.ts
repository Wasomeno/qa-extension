...
// Mock child issues for parent-child relationships
...
export const MOCK_ISSUES: MockIssue[] = [
  {
    ...
    timeTracking: { timeEstimate: 14400, totalTimeSpent: 7200 }, // 4h estimate, 2h spent
  ...
  },
  {
    ...
    timeTracking: { timeEstimate: 28800, totalTimeSpent: 10800 }, // 8h estimate, 3h spent
